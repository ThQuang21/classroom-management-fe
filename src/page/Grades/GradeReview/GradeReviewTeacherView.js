...
export default function GradeReviewTeacherView({gradeReview}) {
      ...
      >
        ...
        <List sx={{ width: '100%', bgcolor: 'background.paper' }}>
          <ListItem
            ...
            disableGutters
            secondaryAction={
              <Typography><strong>Your expectation student's grade:</strong> {gradeReview.expectationGrade}</Typography>
            }
          >
            <ListItemText primary={
              <Typography variant="h6" gutterBottom><strong>Grade name:</strong> {gradeReview.gradeCompositionName}</Typography>
            } />
          </ListItem>
        </List>
      </Box>
